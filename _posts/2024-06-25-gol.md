...
{% include youtubePlayer.html id='nqi5Rhcc8mw?si=AVAmqlIEpgweJLHV' %}
...
I.e. We can make a kernel $K$ that sums over a 9 x 9 area, and excludes the center. 
...
Now, with this choice of $K$ and this new rule set, we can implement it in code using the 2D filter from OpenCV.
