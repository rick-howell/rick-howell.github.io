...
\
We then define an **eigenvalue** $$\lambda \in \mathbb{F}$$ as the element satisfying $$Tv = \lambda v$$ if some $$v$$ that isn't the zero vector satisfies this equation. 
...
\
An **eigenvector** of $$\lambda$$ then is a vector $$v$$ (non zero) satisfying $$Tv = \lambda v$$.
...
We can continue inductively to show that $$T^n = (F_n, F_{n+1})$$:
...
$$
\begin{align*}
Tv_1 = (1, 1-\lambda_2) = (-\lambda_1 \lambda_2, \lambda_1) = \lambda_1(-\lambda_2, 1) = \lambda_1 v_1
\end{align*}
$$
